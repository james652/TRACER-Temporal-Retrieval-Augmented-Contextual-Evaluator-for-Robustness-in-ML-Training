        ...
        self.prompt = ChatPromptTemplate.from_messages([
            (
                ...
                (
                    ...
                    "- and model logs, RAG evidence, prior summaries,\n"
                    ...
                    "The evidence_for_attack string MUST begin with a [NUMERIC_EVIDENCE] section\n"
                    "that cites concrete numbers from logs/accuracies/BWT.\n\n"
...
# ====================================================================================
# Monitor (exec + analysis)  [ablation: no LLM Top-K]
# ====================================================================================
...
def monitor_pipeline(
    ...
    print(f"[CFG] USE_RAG={USE_RAG}  USE_VISION={USE_VISION}  (TOPK ablation: disabled)")
...
if __name__ == "__main__":
    ...
    # Legacy execution path  [ablation: no Top-K injection]
    build = {
