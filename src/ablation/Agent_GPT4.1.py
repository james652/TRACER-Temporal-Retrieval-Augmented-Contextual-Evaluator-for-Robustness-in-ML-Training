...
if __name__ == "__main__":
    ...
    choice = input("Which program should be run? (Brainwash / brainwash_miniimagenet/ brainwash_cifar10 / accumulative_cifar100/ brainwash_tinyimagenet / Accumulative / Detect / Rethink/ Rethink_pub) [Brainwash]: ").strip() or "Brainwash"
