...
if __name__ == "__main__":
    ...
    choice = input("어떤 프로그램을 실행할까요? (Brainwash / brainwash_miniimagenet/ brainwash_cifar10 / accumulative_cifar100/ brainwash_tinyimagenet / Accumulative / Test / Analysis / Analysis_Accumulative  / MMD_backdoor / MMD_backdoor_cifar100 / Detect / Rethink/ Rethink_pub / FGSM / PGD / PhysPatch) [Brainwash]: ").strip() or "Brainwash"
